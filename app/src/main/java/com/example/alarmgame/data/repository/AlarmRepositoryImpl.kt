...
class AlarmRepositoryImpl
    ...
    constructor(
        ...
        override fun observeAlarms(): Flow<List<Alarm>> = alarmDao.observeAlarms().map { entities -> entities.map { it.toDomain() } }
        ...
        override suspend fun toggleEnabled(
            id: Long,
            enabled: Boolean,
            updatedAt: Long,
        ) {
        ...
        override suspend fun updateNextTrigger(
            id: Long,
            nextTriggerAt: Long,
            updatedAt: Long,
        ) {
        ...
        override suspend fun enabledAlarms(): List<Alarm> = alarmDao.getEnabled().map { it.toDomain() }
    }
